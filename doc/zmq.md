...
The Blancoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Blancoin Core requires the ZeroMQ API >= 4.0.0
...
using. Blancoind appends an up-counting sequence number to each
