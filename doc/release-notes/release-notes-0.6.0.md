Blancoin version 0.6.0 is now available for download at:
http://sourceforge.net/projects/ilancoin/files/Blancoin/ilancoin-0.6.0/test/
...
Blancoin-Qt can display and save QR codes for sending
...
versions of Blancoin-Qt/ilancoind.
...
Blancoin-Qt's initial splash screen
...
opening/launching Blancoin-Qt is available only on Linux,
and only if you configure your desktop to launch
Blancoin-Qt. All platforms support dragging and dropping
ilancoin: URIs onto the Blancoin-Qt window to start
payment.
...
It is expected that future releases of Blancoin-Qt
