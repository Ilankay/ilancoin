Blancoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/ilancoin/files/Blancoin/ilancoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Blancoin-Qt to crash on Windows when exiting.
