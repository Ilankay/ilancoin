ilancoind version 0.4.3 is now available for download at:
http://luke.dashjr.org/programs/ilancoin/files/ilancoind-0.4.3/ (until Gavin uploads to SourceForge)

This is a bugfix-only release based on 0.4.0.

Please note that the wxBlancoin GUI client is no longer maintained nor supported. If someone would like to step up to maintain this, they should contact Luke-Jr.
...
No longer accept inbound connections over the internet when Blancoin is being used with Tor (identity leak).
