Ilancoin Core version 0.10.4 is now available from:

  <https://ilancoin.org/bin/ilancoin-core-0.10.4/>
...
- #6953 `43c2789` Split ilancoin-tx into its own package
- #6953 `dfe0d4d` Include ilancoin-tx binary on Debian/Ubuntu
