Ilancoin Core version 0.16.1 is now available from:

  <https://ilancoincore.org/bin/ilancoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting ilancoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure ilancoind processes are cleaned up when tests end (sdaftuar)
