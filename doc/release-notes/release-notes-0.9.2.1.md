Ilancoin Core version 0.9.2.1 is now available from:

  https://ilancoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ILC to 0.01 ILC
...
- Fix "Start ilancoin on system login"
