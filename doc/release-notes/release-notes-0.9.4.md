Blancoin Core version 0.9.4 is now available from:
...
this update is incompatible with the Blancoin system and could lead to consensus
forks.

Blancoin Core released binaries from https://ilancoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ilancoin/+archive/ubuntu/ilancoin
- A third-party or self-compiled Blancoin Core

upgrade to Blancoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
