Ilancoin Core version 0.9.4 is now available from:

  https://ilancoin.org/bin/0.9.4/
...
this update is incompatible with the Ilancoin system and could lead to consensus
forks.

Ilancoin Core released binaries from https://ilancoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ilancoin/+archive/ubuntu/ilancoin
- A third-party or self-compiled Ilancoin Core

upgrade to Ilancoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
