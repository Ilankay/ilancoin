...
Ilancoin Core version 0.19.1 is now available from:

  <https://ilancoincore.org/bin/ilancoin-core-0.19.1/>
...
From Ilancoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Ilancoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Ilancoin Core does not yet change appearance when
...
- #17488 fix "ilancoind already running" warnings on macOS (fanquake)
