Ilancoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ilancoin/files/Ilancoin/ilancoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Ilancoin
...
New/changed settings (command-line or ilancoin.conf file)
--------------------------------------------------------
