Ilancoin Core version 0.13.0 is now available from:
...
Various code modernizations have been done. The Ilancoin Core code base has
...
HD wallets are incompatible with older versions of Ilancoin Core.
...
proposed parameters, a future release of Ilancoin Core is expected that
...
The two phases are distinct in the Ilancoin-Qt GUI. During the first one,
...
- #8207 `f7a403b` Add a link to the Ilancoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8164 `0f24eaf` [Ilancoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
