Blancoin version 0.4.1 is now available for download at:
http://sourceforge.net/projects/ilancoin/files/Blancoin/ilancoin-0.4.1/
...
The wallet encryption feature introduced in Blancoin version 0.4.0 did not sufficiently secure the private keys. An attacker who
managed to get a copy of your encrypted wallet.dat file might be able to recover some or all of the unencrypted keys and steal the
associated coins.

If you have a previously encrypted wallet.dat, the first time you run wxilancoin or ilancoind the wallet will be rewritten, Blancoin will
...
Wallets encrypted with this version of Blancoin are written properly.
...
1. Run Blancoin and let it rewrite the wallet.dat file

2. Run it again, then ask it for a new ilancoin address.
wxBlancoin: new address visible on main window
...
4. Shut down Blancoin, then backup the wallet.dat file.
