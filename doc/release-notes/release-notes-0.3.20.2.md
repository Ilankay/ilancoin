...
The Amazon Machine Images I used to do the builds are available:
  ...
  ami-38a05251   Blancoin-v0.3.20.2 Mingw    (Windows; Administrator password 'ilancoin development')
  ami-30a05259   Blancoin_0.3.20.2 Linux32
  ami-8abc4ee3   Blancoin_0.3.20.2 Linux64
