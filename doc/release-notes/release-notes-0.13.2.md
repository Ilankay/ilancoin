Blancoin Core version 0.13.2 is now available from:

  <https://ilancoin.org/bin/ilancoin-core-0.13.2/>
...
- #8908 `4a974b2` Update ilancoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ilancoin-tx to create v2 transactions (btcdrak)
