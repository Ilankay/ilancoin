Ilancoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ilancoin/files/Ilancoin/ilancoin-0.5.4/
...
http://gitorious.org/ilancoin/ilancoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Ilancoin-Qt notifications under Growl 1.3.
Increase required age of Ilancoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIlancoin properly when installing Ilancoin-Qt over it. (Windows)
