Blancoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ilancoin/files/Blancoin/ilancoin-0.5.4/
...
Fix Blancoin-Qt notifications under Growl 1.3.
Increase required age of Blancoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBlancoin properly when installing Blancoin-Qt over it. (Windows)
