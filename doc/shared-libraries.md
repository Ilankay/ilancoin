...
The purpose of this library is to make the verification functionality that is critical to Blancoin's consensus available to other applications, e.g. to language bindings.
...
- `ilancoinconsensus_ERR_INVALID_FLAGS` - Script verification `flags` are invalid (i.e. not part of the libconsensus interface)

### Example Implementations
- [NBlancoin](https://github.com/MetacoSA/NBlancoin/blob/5e1055cd7c4186dee4227c344af8892aea54faec/NBlancoin/Script.cs#L979-#L1031) (.NET Bindings)
