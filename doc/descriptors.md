# Support for Output Descriptors in Blancoin Core

Since Blancoin Core v0.17, there is support for Output Descriptors. This is a
...
on Blancoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Blancoin Core wallets, a convenience function `combo` is
...
All RPCs in Blancoin Core will include the checksum in their output. Only
