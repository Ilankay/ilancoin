# Fuzzing Blancoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Blancoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/ilancoin/ilancoin
$ cd ilancoin/
$ ./autogen.sh
$ CC=clang CXX=clang++ ./configure --enable-fuzz --with-sanitizers=address,fuzzer,undefined
# macOS users: If you have problem with this step then make sure to read "macOS hints for
# libFuzzer" on https://github.com/ilancoin/ilancoin/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/ilancoin/ilancoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/ilancoin/ilancoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/ilancoin/ilancoin/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`ilancoin-core/qa-assets`](https://github.com/ilancoin-core/qa-assets) repo.

To fuzz `process_message` using the [`ilancoin-core/qa-assets`](https://github.com/ilancoin-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/ilancoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`ilancoin-core/qa-assets`](https://github.com/ilancoin-core/qa-assets) repo.

Every single pull request submitted against the Blancoin Core repo is automatically tested against all inputs in the [`ilancoin-core/qa-assets`](https://github.com/ilancoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Blancoin Core more robust.
...
with certain assembly code from Blancoin Core's code. See [developer notes on sanitizers](https://github.com/ilancoin/ilancoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Blancoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Blancoin Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Blancoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Blancoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
