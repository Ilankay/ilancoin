# Fuzzing Ilancoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Ilancoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the Ilancoin Core repo is automatically tested against all inputs in the [`ilancoin-core/qa-assets`](https://github.com/ilancoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Ilancoin Core more robust.
...
with certain assembly code from Ilancoin Core's code. See [developer notes on sanitizers](https://github.com/ilancoin/ilancoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Ilancoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Ilancoin Core using [`afl-fuzz`](https://github.com/google/afl):
