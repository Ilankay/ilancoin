...
Running ilancoind as a daemon does not require any manual configuration. You may
set the `rpcauth` setting in the `ilancoin.conf` configuration file to override
...
Configuration file:  `~/Library/Application Support/Blancoin/ilancoin.conf`
Data directory:      `~/Library/Application Support/Blancoin`
Lock file:           `~/Library/Application Support/Blancoin/.lock`
