# PSBT Howto for Blancoin Core

Since Blancoin Core 0.17, an RPC interface exists for Partially Signed Blancoin
...
PSBT is an interchange format for Blancoin transactions that are not fully signed
...
#### Multisig with multiple Blancoin Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
Blancoin Core. We assume their wallets only contain the multisig funds. In case
