...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the ilancoin repository."
  exit 1
fi
...
# See https://github.com/ilancoin/ilancoin/issues/16064
...
echo 'When compiling ilancoind, run `./configure` in the following way:'
echo
