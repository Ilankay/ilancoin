...
# Deterministically build Blancoin Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/ilancoin'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/ilancoin/' to
        #     '/home/satoshi/ilancoin/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/ilancoin
        #
        #                     maps our current working directory to /ilancoin
        ...
        #     container so that we have something to build. '/ilancoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /ilancoin && bash contrib/guix/libexec/build.sh"
    )
