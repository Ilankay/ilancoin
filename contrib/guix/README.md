# Bootstrappable Blancoin Core Builds

This directory contains the files necessary to perform bootstrappable Blancoin
Core builds.
...
- 24GB of free disk space on the partition that the Blancoin Core git repository
  resides in
...
From the top of a clean Blancoin Core repository:
...
To use dongcarl's substitute server for Blancoin Core builds after having
