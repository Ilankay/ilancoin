# Bootstrappable Ilancoin Core Builds

This directory contains the files necessary to perform bootstrappable Ilancoin
Core builds.
...
- 24GB of free disk space on the partition that the Ilancoin Core git repository
  resides in
...
For a Ilancoin Core depends development environment, simply invoke
...
From the top of a clean Ilancoin Core repository:
...
To use dongcarl's substitute server for Ilancoin Core builds after having
