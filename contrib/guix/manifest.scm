...
(define* (make-ilancoin-cross-toolchain target
                                  #:key
...
desirable for building Ilancoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-ilancoin-cross-toolchain "i686-linux-gnu")
       (make-ilancoin-cross-toolchain "x86_64-linux-gnu")
       (make-ilancoin-cross-toolchain "aarch64-linux-gnu")
       (make-ilancoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-ilancoin-cross-toolchain "riscv64-linux-gnu"
