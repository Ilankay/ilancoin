...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Blancoin
else
  DOCKER_EXEC echo \> \$HOME/.ilancoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/ilancoin/ilancoin/pull/18288#discussion_r433189350 for
  # details.
