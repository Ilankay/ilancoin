...
#ifndef ILANCOIN_SCRIPT_STANDARD_H
#define ILANCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a ilancoin address
 */
...
/**
 * Generate a Blancoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ILANCOIN_SCRIPT_STANDARD_H
