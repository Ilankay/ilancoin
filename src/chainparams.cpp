...
{
    const char* pszTimestamp = "CNN 10/JAN/2025 Donald Trump will enter the White House as a felon";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1736545871, 3785522035, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000e0b88f968e73b67010813f08a80ad686703bc52923a1d8ccab80c082"));
        assert(genesis.hashMerkleRoot == uint256S("0x21d106f4d1cfd218c550112b140d31a472225d0bfbde1c533aa7d8712617279f"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1736623623, 848471977, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000daa3c6f1553327b886ea5e39bcdbee886ee9ba060b6a63b27e88ad22"));
        assert(genesis.hashMerkleRoot == uint256S("0x21d106f4d1cfd218c550112b140d31a472225d0bfbde1c533aa7d8712617279f"));
