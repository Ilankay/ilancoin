...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Ilancoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Ilancoin
    // Mac: ~/Library/Application Support/Ilancoin
    // Unix: ~/.ilancoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ilancoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ilancoin";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Ilancoin Core copyright is not removed by accident
    if (copyright_devs.find("Ilancoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Ilancoin Core developers";
    }
