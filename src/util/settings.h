// Copyright (c) 2019-2020 The Ilancoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ILANCOIN_UTIL_SETTINGS_H
#define ILANCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/ilancoin/ilancoin/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored ilancoin settings. This struct combines settings from the command line
...
#endif // ILANCOIN_UTIL_SETTINGS_H
