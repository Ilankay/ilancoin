 ...
 */
#ifndef ILANCOIN_UTIL_SYSTEM_H
#define ILANCOIN_UTIL_SYSTEM_H
...
extern const char * const ILANCOIN_CONF_FILENAME;
extern const char * const ILANCOIN_SETTINGS_FILENAME;
