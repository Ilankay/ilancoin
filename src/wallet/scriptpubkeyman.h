...
#ifndef ILANCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define ILANCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Ilancoin Core wallet was originally a collection of unrelated private
...
#endif // ILANCOIN_WALLET_SCRIPTPUBKEYMAN_H
