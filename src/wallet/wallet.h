...
#ifndef ILANCOIN_WALLET_WALLET_H
#define ILANCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this ilancoin node, and set to 0 for transactions that were created
...
#endif // ILANCOIN_WALLET_WALLET_H
