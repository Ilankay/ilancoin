...
#ifndef ILANCOIN_COMPAT_ASSUMPTIONS_H
#define ILANCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Blancoin cannot be compiled without assertions."
#endif
...
#endif // ILANCOIN_COMPAT_ASSUMPTIONS_H
