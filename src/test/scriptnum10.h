...
#ifndef ILANCOIN_TEST_SCRIPTNUM10_H
#define ILANCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Blancoin Core 0.10.0, for cross-comparison.
 */
public:
