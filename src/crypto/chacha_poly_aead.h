...
#ifndef ILANCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define ILANCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@ilancoin.
 *
 ...
 *
 * The chacha20-poly1305@ilancoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@ilancoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@ilancoin are relatively fast in
...
#endif // ILANCOIN_CRYPTO_CHACHA_POLY_AEAD_H
