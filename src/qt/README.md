This directory contains the BlancoinQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the Blancoin UI.
...
* UI elements like BlancoinAmountField, which inherit from QWidget.
