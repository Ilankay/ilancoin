    ...
    platformStyle(_platformStyle)
{
    ...
    // normal ilancoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying ilancoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BlancoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
