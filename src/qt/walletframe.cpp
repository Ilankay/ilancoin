...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, BlancoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &BlancoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &BlancoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &BlancoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &BlancoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &BlancoinGUI::updateWalletStatus);
    connect(gui, &BlancoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
