    ...
    mapper(nullptr)
{
    ...
    ui->openBlancoinConfButton->setToolTip(ui->openBlancoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BlancoinUnits(this));
...
void OptionsDialog::on_openBlancoinConfButton_clicked()
{
