    ...
    mapper(nullptr)
{
    ...
    ui->ilancoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ilancoinAtStartup);
    ...
    ui->ilancoinAtStartup->setToolTip(ui->ilancoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ilancoinAtStartup->setText(ui->ilancoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openIlancoinConfButton->setToolTip(ui->openIlancoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new IlancoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ilancoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openIlancoinConfButton_clicked()
{
