...
#ifndef ILANCOIN_QT_SPLASHSCREEN_H
#define ILANCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Ilancoin Core initialization
...
#endif // ILANCOIN_QT_SPLASHSCREEN_H
