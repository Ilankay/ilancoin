...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BlancoinAmountField*>("payAmount")->setValue(amount);
...
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = BlancoinUnits::formatWithUnit(unit, balance, false, BlancoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    BlancoinAmountField* amountInput = receiveCoinsDialog.findChild<BlancoinAmountField*>("reqAmount");
