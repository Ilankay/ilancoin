...
//! Entry point for IlancoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &IlancoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for IlancoinGUI tests.
void AppTests::guiTests(IlancoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &IlancoinGUI::consoleShown, this, &AppTests::consoleTests);
