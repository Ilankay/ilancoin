...
//! Entry point for BlancoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BlancoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BlancoinGUI tests.
void AppTests::guiTests(BlancoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BlancoinGUI::consoleShown, this, &AppTests::consoleTests);
