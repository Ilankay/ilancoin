...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Ilancoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Ilancoin Core"
...
#define PACKAGE_NAME "Ilancoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ilancoin Core 0.19.99"
