...
// ilancoin includes.
#include <..\src\script\ilancoinconsensus.h>
...
int main()
{
    std::cout << "ilancoinconsensus version: " << ilancoinconsensus_version() << std::endl;
    ...
    auto op0Result = ilancoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, ilancoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
