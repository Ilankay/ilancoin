...
class TestShell:
    """Wrapper Class for BlancoinTestFramework.

    The TestShell class extends the BlancoinTestFramework
    ...
    class __TestShell(BlancoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BlancoinTestFramework child class.
            self.num_nodes = 1
