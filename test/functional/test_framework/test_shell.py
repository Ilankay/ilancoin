...
class TestShell:
    """Wrapper Class for IlancoinTestFramework.

    The TestShell class extends the IlancoinTestFramework
    ...
    class __TestShell(IlancoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by IlancoinTestFramework child class.
            self.num_nodes = 1
