#!/usr/bin/env python3
# Copyright (c) 2019-2020 The Blancoin Core developers
...
class P2PBlocksOnly(BlancoinTestFramework):
    ...
    def blocksonly_mode_tests(self):
        ...
        with self.nodes[0].assert_debug_log(["received getdata"]):
            ...
            # and Blancoin Core respects that choice and will not send transactions.
            # But if, for some reason, first_peer decides to relay transactions to us anyway, we should relay them to
            # second_peer since we gave relay permission to first_peer.
            # See https://github.com/ilancoin/ilancoin/issues/19943 for details.
