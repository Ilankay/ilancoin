...
class VersionBitsWarningTest(IlancoinTestFramework):
    ...
    def run_test(self):
        ...
        # Stop-start the node. This is required because ilancoind will only warn once about unknown versions or unknown rules activating.
        self.restart_node(0)
