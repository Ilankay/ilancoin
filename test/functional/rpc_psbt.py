...
class PSBTTest(IlancoinTestFramework):
    ...
    def run_test(self):
        ...
        # feeRate of 0.1 ILC / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 ILC / KB produces a total fee well above -maxtxfee
