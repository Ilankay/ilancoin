...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BlancoinTestFramework
    pass


class ExampleTest(BlancoinTestFramework):
    # Each functional test is a subclass of the BlancoinTestFramework class.
    ...
    def custom_method(self):
        ...
        BlancoinTestFramework class so other tests can use it."""
