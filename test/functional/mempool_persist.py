...
By default, ilancoind will dump mempool on shutdown and
...
class MempoolPersistTest(BlancoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ilancoind from writing mempool.dat to disk. Verify that `savemempool` fails")
