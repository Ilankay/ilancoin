#!/usr/bin/env python3
# Copyright (c) 2018-2020 The Ilancoin Core developers
...
class AvoidReuseTest(IlancoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 ILC with
