...
class P2PPermissionsTests(IlancoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].ilancoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].ilancoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
