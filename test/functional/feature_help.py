...
"""Verify that starting ilancoin with -h works as expected."""

from test_framework.test_framework import BlancoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BlancoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ilancoin with -h for help text")
        ...
        self.log.info("Start ilancoin with -version for version information")
        ...
        self.log.info("Start ilancoind with -fakearg to make sure it does not start")
