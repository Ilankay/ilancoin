...
class BumpFeeTest(BlancoinTestFramework):
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for mode in ["foo", Decimal("3.1415"), "sat/B", "ILC/kB"]:
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Blancoin to serialize ECDSA signatures means that signatures can have a
