#!/usr/bin/env python3
# Copyright (c) 2017-2020 The Ilancoin Core developers
...
class ConfArgsTest(IlancoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'ilancoin.conf'), 'a', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "ilancoin.conf")
