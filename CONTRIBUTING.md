Contributing to Ilancoin Core
============================

The Ilancoin Core project operates an open contributor model where anyone is
...
list or participate in a weekly [Ilancoin Core PR Review Club](https://ilancoincore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Ilancoin Core development happens on IRC, in the
...
The following applies to code changes to the Ilancoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Ilancoin
Network Protocol consensus changes.

Whether a pull request is merged into Ilancoin Core rests with the project merge
...
Patches that change Ilancoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ilancoin consensus, it must have been
...
The project leader is the release manager for each Ilancoin Core release.
